...
public class AlphabetaPlayer implements Player {
    ...
    public int alphaBeta(Connect4Board board, int depth,int alpha,int beta, boolean isMaximizing) {
...
//    			return bestScore
    		...
    		for(col = 0; cols < board.numCols(); cols++) {
    			if(board.isValidMove(col)) {
        			board.move(cols, id);
            		bestScore = Math.min(bestScore, alphaBeta(board, depth - 1, alpha, beta, true));
